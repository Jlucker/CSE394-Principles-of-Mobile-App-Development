...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.firstLabel.text = "It's going to rain tonight";
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        {
            if let detailviewController: SecondViewController = segue.destinationViewController as? SecondViewController {
                detailviewController.fromFirstView = self.firstLabel.text!;
            }
        }
    }
}